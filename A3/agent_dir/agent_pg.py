...
#so if you want to do off-policy, you need 2 different agents! -->HOW???
    def update(self):
        ...
        for log_prob, R in zip(self.saved_log_probs, returns):
            ...
            loss.append(-log_prob*R) #need more study!! Ask TA if needed-->different from https://www.youtube.com/watch?v=puKAEWkZDSE 26:12
        # TODO:
    ...
    def train(self):
        ...
        for epoch in range(self.num_episodes): #1 episode is 1 trajectory; play the game for 1 time; you get 1 tau
            ...
            while(not done): #the while loop here is the true trajectory
                ...
                #input()
                self.saved_actions.append(action)  #action the agent made
                self.rewards.append(reward)  #reward from the env
                num_of_steps+=1
