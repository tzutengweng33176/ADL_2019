...
class DataProcessor(object):
    ...
    def _read_csv(cls, input_file, quotechar=None):
        ...
        with open(input_file, "r") as f:
            ...
            #print(data) #a list of orderedDict
            #input()
            return data
class MyTaskProcessor(DataProcessor):
    """Processor for the ADL HW2 data set."""
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            guid = "%s" % (line['Id'])
            text_a = line['text']
            #print("text_a: ", text_a) #correct
            #text_b = line[9] #this is a single sequebce task
            #label = line[-1]
            #print("Label: ", label) #correct
            #input()
            examples.append(
...
def main():
    ...
    tr_loss = 0
    if args.do_train:
        print("When testing, you should NOT execute this part! ")
        input()
    ...
    if args.do_predict and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        if os.path.exists(args.prediction_output_dir) and os.listdir(args.prediction_output_dir) and args.do_predict:
            raise ValueError("Output directory ({}) already exists and is not empty.".format(args.prediction_output_dir))
        ...
        Ids = [e.guid for e in test_examples]
        #print("Ids: ", Ids) 
        ...
        for input_ids, input_mask, segment_ids in tqdm(eval_dataloader, desc="Predicting"):
            ...
            #print("logits: ", logits.shape) # torch.Size([8, 5])
            #print("logits: ", logits)
            #input()
            nb_eval_steps += 1
            if len(preds) == 0:
        ...
        #print("preds: ", preds)
        output_eval_file = os.path.join(args.prediction_output_dir, "prediction.csv")
